...
class BitcoinRPC {
private:
    bitcoinrpc::HttpClient * httpClient;
    bitcoinrpc::Client * client;

public:
    /* === Constructor and Destructor === */
    BitcoinRPC( const std::string &user ,const std::string& password ,const std::string& host ,int port ,int httpTimeout=2000 );
    ~BitcoinRPC();
