...
///////////////////////////////////////////////////////////////////////////////
using bitcoinrpc::HttpClient;
using bitcoinrpc::Client;
using bitcoinrpc::JSONRPC_CLIENT_V1;
...
BitcoinRPC::BitcoinRPC( const string &user ,const string &password ,const string& host ,int port ,int httpTimeout ) :
...
Value BitcoinRPC::sendcommand( const string &command ,const Value& params ){
    Value result;

    return client->CallMethod( command ,params );
}

string BitcoinRPC::IntegerToString( int num ) {
	std::ostringstream ss;
	ss << num;
	return ss.str();
}

std::string BitcoinRPC::RoundDouble( double num ) {
	std::ostringstream ss;
	ss.precision(8);
	ss << std::fixed << num;
	return ss.str();
...
void BitcoinRPC::addnode(const string& node, const string& comm) {
...
vector<nodeinfo_t> BitcoinRPC::getaddednodeinfo(bool dns) {
...
vector<nodeinfo_t> BitcoinRPC::getaddednodeinfo(bool dns, const std::string& node) {
	string command = "getaddednodeinfo";
	Value params, result;
	vector<nodeinfo_t> ret;
...
int BitcoinRPC::getconnectioncount() {
...
vector<peerinfo_t> BitcoinRPC::getpeerinfo() {
...
void BitcoinRPC::backupwallet(const string& destination) {
...
string BitcoinRPC::encryptwallet(const string& passphrase) {
...
void BitcoinRPC::walletlock() {
	string command = "walletlock";
	Value params;
	sendcommand(command, params);
}

void BitcoinRPC::walletpassphrase(const string& passphrase, int timeout) {
...
void BitcoinRPC::walletpassphrasechange(const string& oldpassphrase, const string& newpassphrase) {
...
string BitcoinRPC::dumpprivkey(const string& bitcoinaddress) {
...
void BitcoinRPC::importprivkey(const string& bitcoinprivkey) {
...
void BitcoinRPC::importprivkey(const string& bitcoinprivkey, const string& label, bool rescan) {
	string command = "importprivkey";
	Value params;
	params.append(bitcoinprivkey);
	params.append(label);
...
void BitcoinRPC::importaddress(const string& address, const string& account, bool rescan) {
...
string BitcoinRPC::addmultisigaddress(int nrequired, const vector<string>& keys) {
...
string BitcoinRPC::addmultisigaddress(int nrequired, const vector<string>& keys, const string& account) {
	string command = "addmultisigaddress";
	Value params, result;
	params.append(nrequired);
...
multisig_t BitcoinRPC::createmultisig(int nrequired, const vector<string>& keys) {
...
string BitcoinRPC::getnewaddress(const string& account) {
...
validateaddress_t BitcoinRPC::validateaddress(const string& bitcoinaddress) {
...
void BitcoinRPC::keypoolrefill() {
	string command = "keypoolrefill";
	Value params;
	sendcommand(command, params);
}

bool BitcoinRPC::settxfee(double amount) {
...
double BitcoinRPC::estimatefee(int blocks) {
...
string BitcoinRPC::signmessage(const std::string& bitcoinaddress, const std::string& message) {
...
bool BitcoinRPC::verifymessage(const std::string& bitcoinaddress, const std::string& signature, const std::string& message) {
...
double BitcoinRPC::getbalance(const string& account, int minconf, bool includewatchonly) {
	string command = "getbalance";
	Value params, result;
	params.append(account);
...
double BitcoinRPC::getunconfirmedbalance() {
...
double BitcoinRPC::getreceivedbyaccount(const string& account, int minconf) {
...
double BitcoinRPC::getreceivedbyaddress(const string& bitcoinaddress, int minconf) {
...
vector<accountinfo_t> BitcoinRPC::listreceivedbyaccount(int minconf, bool includeempty) {
...
vector<addressinfo_t> BitcoinRPC::listreceivedbyaddress(int minconf, bool includeempty) {
...
gettransaction_t BitcoinRPC::gettransaction(const string& tx, bool watch) {
...
vector<transactioninfo_t> BitcoinRPC::listtransactions() {
...
vector<transactioninfo_t> BitcoinRPC::listtransactions(const string& account, int count, int from) {
	string command = "listtransactions";
	Value params, result;
	vector<transactioninfo_t> ret;
...
string BitcoinRPC::getaccount(const string& bitcoinaddress) {
...
string BitcoinRPC::getaccountaddress(const string& account) {
...
vector<std::string> BitcoinRPC::getaddressesbyaccount(const string& account) {
...
map<string, double> BitcoinRPC::listaccounts(int minconf) {
...
vector< vector<addressgrouping_t> > BitcoinRPC::listaddressgroupings() {
...
bool BitcoinRPC::move(const string& fromaccount, const string& toaccount, double amount, int minconf) {
	string command = "move";
	Value params, result;
...
bool BitcoinRPC::move(const string& fromaccount, const string& toaccount, double amount, const string& comment, int minconf) {
	string command = "move";
	Value params, result;
...
void BitcoinRPC::setaccount(const string& bitcoinaddress, const string& account){
...
string BitcoinRPC::sendtoaddress(const string& bitcoinaddress, double amount) {
...
string BitcoinRPC::sendtoaddress(const string& bitcoinaddress, double amount, const string& comment, const string& comment_to) {
	string command = "sendtoaddress";
	Value params, result;
...
string BitcoinRPC::sendfrom(const string& fromaccount, const string& tobitcoinaddress, double amount) {
...
string BitcoinRPC::sendfrom(const string& fromaccount, const string& tobitcoinaddress, double amount, const string& comment, const string& comment_to, int minconf) {
	string command = "sendfrom";
	Value params, result;
...
string BitcoinRPC::sendmany(const string& fromaccount, const map<string,double>& amounts) {
...
string BitcoinRPC::sendmany(const string& fromaccount, const map<string,double>& amounts, const string comment, int minconf) {
	string command = "sendmany";
	Value params, result;
...
vector<unspenttxout_t> BitcoinRPC::listunspent(int minconf, int maxconf) {
...
vector<txout_t> BitcoinRPC::listlockunspent() {
...
bool BitcoinRPC::lockunspent(bool unlock, const vector<txout_t>& outputs) {
...
string BitcoinRPC::getbestblockhash() {
...
string BitcoinRPC::getblockhash(int blocknumber) {
...
blockinfo_t BitcoinRPC::getblock(const string& blockhash) {
...
void BitcoinRPC::setgenerate(bool generate, int genproclimit) {
...
double BitcoinRPC::getdifficulty() {
...
mininginfo_t BitcoinRPC::getmininginfo() {
...
txsinceblock_t BitcoinRPC::listsinceblock(const string& blockhash, int target_confirmations) {
...
getrawtransaction_t BitcoinRPC::getrawtransaction(const string& txid, int verbose) {
...
decodescript_t BitcoinRPC::decodescript(const std::string& hexString) {
...
decoderawtransaction_t BitcoinRPC::decoderawtransaction(const string& hexString) {
...
string BitcoinRPC::sendrawtransaction(const string& hexString, bool highFee) {
...
string BitcoinRPC::createrawtransaction(const vector<txout_t>& inputs, const map<string,double>& amounts) {
...
string BitcoinRPC::createrawtransaction(const vector<txout_t>& inputs, const map<string,string>& amounts) {
	string command = "createrawtransaction";
	Value params, result;
...
signrawtransaction_t BitcoinRPC::signrawtransaction(const string& rawTx, const vector<signrawtxin_t> inputs) {
...
signrawtransaction_t BitcoinRPC::signrawtransaction(const string& rawTx, const vector<signrawtxin_t> inputs, const vector<string>& privkeys, const string& sighashtype) {
	string command = "signrawtransaction";
	Value params, result;
	signrawtransaction_t ret;
...
vector<string> BitcoinRPC::getrawmempool() {
...
string BitcoinRPC::getrawchangeaddress() {
...
utxoinfo_t BitcoinRPC::gettxout(const std::string& txid, int n, bool includemempool) {
...
utxosetinfo_t BitcoinRPC::gettxoutsetinfo() {
